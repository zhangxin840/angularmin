angular.module('flApps', [
  ...
  '$timeout',
  '$location',
  function (appCollection, configs, helpers, remote, $rootScope, $timeout, $location) {
    ...
    helpers.deepExtend(configs.appendRequest, { location: window.location.href });
